...
import type { FighterNote } from "@/lib/types";
...
// The permanent, cross-event scouting book: every fighter you've noted or
// tagged, searchable, independent of which card they're next booked on.
// Lives inside the Notes page's own "Notes history" section now - this used
// to be the whole Library tab.
export function NotesHistoryPanel({
  ...
  // only show fighters that still have something: a note or tags
      ...
      {all.length === 0 && (
        <div className="space-y-4">
          <div className="rounded-xl border border-emerald-900/60 bg-neutral-900/40 p-4">
            ...
            <p className="text-xs text-neutral-500 mt-1">
              Open Upcoming Events above and start typing in a fighter&apos;s notes box -
