...
// unverified ("other") bets - you grade them - because the price isn't the
// sharp board's, so there's nothing to auto-verify against.
  ...
  function submit() {
    ...
    if (needsLine) {
      ...
      if (isNaN(ouLine) || ouLine <= 0) {
        setError("Enter a total in rounds, e.g. 2.5.");
        return;
      }
    }
